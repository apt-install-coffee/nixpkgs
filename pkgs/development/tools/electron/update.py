...
#! nix-shell -i python -p python3 nix nix-universal-prefetch prefetch-yarn-deps prefetch-npm-deps
...
subprocess.check_call([
    ...
    "--rev", "543fdf32d15fe47a0beadc3f5a3e0d6218ad237c"])
...
def get_npm_hash(repo, package_lock_path = 'package.lock'):
...
for major_version in range(25, 24, -1):
